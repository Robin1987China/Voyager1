...
set PID_TAG="VOYAGER1_SERVER_APPLICATION"
...
set APP_OPTS= -Dvoyager1.application.tag="%PID_TAG%" -Dlogging.config="%logback_configurationFile%" -Dspring.config.location="%application_conf%"
...
if "%1"=="" (
    color 0a
    TITLE Voyager1 management system BAT console
    echo. ***** Voyager1 management system BAT console *****
    echo. !JAR_MSG!
    ::*************************************************************************************************************
    echo.
        echo.  [1] start

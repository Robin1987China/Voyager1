 ...
 */
@Data
@ConfigurationProperties("voyager1.user")
public class UserConfig {
    ...
    public byte[] getTokenJwtKeyByte() {
        // 默认 JWT 密钥仅用于开发环境，生产部署务必通过配置 tokenJwtKey 覆盖
        return (this.tokenJwtKey == null || this.tokenJwtKey.isEmpty() ? "KZQfFBJTW2v6obS1" : this.tokenJwtKey).getBytes();
    }
}

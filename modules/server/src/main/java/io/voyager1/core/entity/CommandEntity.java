 ...
 */
@Entity
@Table(name = "OPS_COMMAND")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CommandEntity implements WorkspaceEntity {
    ...
    @Column(name = "defParams", columnDefinition = "TEXT")
    private String defParams;

    @Column(name = "sshIds", columnDefinition = "TEXT")

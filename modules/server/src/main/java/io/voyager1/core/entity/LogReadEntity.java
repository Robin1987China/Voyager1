 ...
 */
@Entity
@Table(name = "OPS_LOG_FILE")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class LogReadEntity implements WorkspaceEntity {
    ...
    @Column(name = "nodeProject", columnDefinition = "TEXT")
    private String nodeProject;

    @Column(name = "cacheData", columnDefinition = "TEXT")

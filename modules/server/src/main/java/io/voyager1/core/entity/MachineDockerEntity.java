 ...
 * 机器 DOCKER 信息 JPA 实体。
 * <p>
 * 模型层 tlsVerify/certExist/swarmControlAvailable/enableSsh/sshUseSudo 为 Boolean，DB 列为 TINYINT(Integer)。
 */
@Entity
@Table(name = "INFRA_MACHINE_DOCKER")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MachineDockerEntity {
    ...
    @Column(name = "failureMsg", length = 255)
    ...
    @Column(name = "dockerVersion", columnDefinition = "TEXT")
    ...
    @Column(name = "swarmControlAvailable")
    private Integer swarmControlAvailable;

    @Column(name = "swarmCreatedAt")
    private Long swarmCreatedAt;

    @Column(name = "swarmUpdatedAt")
    private Long swarmUpdatedAt;

    @Column(name = "swarmNodeAddr", length = 50)
    private String swarmNodeAddr;

    @Column(name = "certInfo", length = 100)
    private String certInfo;

    @Column(name = "certExist")
    private Integer certExist;

    @Column(name = "enableSsh")
    private Integer enableSsh;

    @Column(name = "machineSshId", length = 255)
    private String machineSshId;

    @Column(name = "sshUseSudo")
    private Integer sshUseSudo;
}

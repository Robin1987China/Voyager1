 ...
 */
@Entity
@Table(name = "OPS_SCRIPT")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class NodeScriptCacheEntity implements WorkspaceEntity {
    ...
    @Column(name = "defArgs", columnDefinition = "TEXT")
    private String defArgs;

    @Column(name = "description", length = 255)
    private String description;

    @Column(name = "scriptType", length = 100)

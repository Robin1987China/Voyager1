...
import io.voyager1.configuration.*;
...
public class ServerConfig implements InitializingBean {
    ...
    public ServerConfig(Voyager1Application configBean) {
    ...
    public File getUserTempPath() {
        ...
        if (userModel == null) {
            throw new Voyager1RuntimeException("没有登录");
        }
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (!Validator.isGeneral(clusterId1, 1, 20)) {
            throw new Voyager1RuntimeException("请配置正确的集群Id,【voyager1.clusterId】");
        }
        ...
        messageSizeLimit = (messageSizeLimit != null ? messageSizeLimit : DataSize.ofMegabytes(5));
        System.setProperty("VOYAGER1_NODE_WEB_SOCKET_MESSAGE_SIZE_LIMIT", messageSizeLimit.toBytes() + "");
    }
    ...
    public File fileStorageSavePath() {
        ...
        if ((savePah == null || savePah.isEmpty())) {

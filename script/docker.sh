...
# docker run -d -p 2122:2122 --name voyager1-server -v /etc/localtime:/etc/localtime:ro -v voyager1-server-vol:/usr/local/voyager1-server ${VOYAGER1_IMAGE_REPO:-voyager1}/voyager1:mac-arm-0.0.1.1

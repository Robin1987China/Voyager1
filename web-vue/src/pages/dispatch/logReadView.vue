  ...
  <div>
    ...
    <n-layout class="file-layout">
      ...
      <n-layout-sider theme="light" class="sider" width="25%">
        <div class="dir-container">
          <template v-if="temp.projectList && temp.cacheData">
            <n-form layout="inline" autocomplete="off">
              <n-form-item :label="$t('i18n_3bf3c0a8d6')">
                <n-select
                  :value="`${temp.cacheData.useNodeId},${temp.cacheData.useProjectId}`"
                  style="width: 200px"
                  :placeholder="$t('i18n_f8a613d247')"
                  :options="
                    temp.projectList.map((item) => ({
                      label: nodeName[item.nodeId] && nodeName[item.nodeId].name,
                      value: `${item.nodeId},${item.projectId}`
                    }))
                  "
          ...
          <!-- <n-button size="small" type="primary" @click="loadFileData">刷新目录</n-button> -->
        </div>
      ...
      <n-layout-content class="file-content">
        <div v-if="temp.cacheData" class="log-filter">
          <n-space direction="vertical" style="width: 100%">
            ...
            <n-form layout="inline" autocomplete="off">
              <n-space direction="vertical" style="width: 100%">
                <n-space>
                  <n-form-item :label="$t('i18n_5349f417e9')">
                    <!-- 关键词： -->
                    <!-- ^.*\d+.*$ -->
                    <!-- .*(0999996|0999995).*   .*(a|b).* -->
                  ...
                  <n-form-item :label="$t('i18n_a20341341b')">
                    <n-input-number
                      id="inputNumber"
                  ...
                  <n-form-item :label="$t('i18n_10d6dfd112')">
                    <n-input-number
                      id="inputNumber"
                  ...
                  <n-popover>
                    ...
                    <template #header>{{ $t('i18n_108d492247') }}</template>
                ...
                <n-space>
                  <n-form-item :label="$t('i18n_ff9dffec4d')">
                    <!--  -->
                    <n-tooltip placement="right">
                      <template #trigger>
                        <span class="tw">
                          <n-select
                            ...
                            :options="[
                              { label: $t('i18n_518df98392'), value: 'false' },
                              { label: $t('i18n_9914219dd1'), value: 'true' }
                            ]"
                            @change="
                              (value) => {
                  ...
                  <n-form-item :label="$t('i18n_d82ab35b27')">
                    <n-input-number
                      id="inputNumber"
                  ...
                  <n-form-item :label="$t('i18n_10145884ba')">
                    <n-input-number
                      id="inputNumber"
                  ...
                  <n-popover>
                    ...
                    <template #header>{{ $t('i18n_257dc29ef7') }}</template>
        ...
        <n-tabs v-if="temp.cacheData" v-model:value="activeTagKey" :tab-bar-style="{ marginBottom: 0 }">
          <template v-for="item in temp.projectList">
            <n-tab-pane v-if="nodeName[item.nodeId]" :key="`${item.nodeId},${item.projectId}`" force-render>
              <template #tab>
...
export default {
  ...
  methods: {
    ...
    initWebSocket(id, url, item) {
      const socket = new ReconnectSocket(url)
